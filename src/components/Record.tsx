...
const VoiceRecorder: React.FC = () => {
  ...
  const playWithGoogleVoice = () => {
    ...
    const handleLogout = async () => {
      ...
      const response = await fetch('patient/logout', {
          method: 'POST',
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen  bg-emerald-800 relative">
      {/* <button className="fixed top-1 right-1 bg-white text-emerald-800 font-bold p-2 px-4 border border-gray-300 rounded-lg text-lg cursor-pointer transition-all 
        hover:bg-gray-100 hover:text-gray-800 focus:outline-none focus:border-gray-500"
